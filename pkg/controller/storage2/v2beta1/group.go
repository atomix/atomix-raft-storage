...
func addRaftGroupController(mgr manager.Manager) error {
	...
	err = controller.Watch(&source.Kind{Type: &storagev2beta1.RaftGroup{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// Watch for changes to secondary resource RaftMember
	err = controller.Watch(&source.Kind{Type: &storagev2beta1.RaftMember{}}, &handler.EnqueueRequestForOwner{
		OwnerType:    &storagev2beta1.RaftGroup{},
		IsController: true,
	})
	if err != nil {
		return err
...
func (r *RaftGroupReconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	var cluster *storagev2beta1.MultiRaftCluster
...
func (r *RaftGroupReconciler) reconcileMembers(cluster *storagev2beta1.MultiRaftCluster, group *storagev2beta1.RaftGroup) (bool, error) {
...
func (r *RaftGroupReconciler) reconcileMember(group *storagev2beta1.RaftGroup, memberID int, readOnly bool) (bool, error) {
