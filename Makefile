...
test: build license_check linters
	go test github.com/atomix/atomix-raft-storage-plugin/...
...
images: build
	docker build . -f build/docker/Dockerfile -t atomix/atomix-raft-storage-controller:${ATOMIX_RAFT_STORAGE_VERSION}
